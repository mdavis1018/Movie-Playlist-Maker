...
public:
  ...
  void SearchMovie();
  // Name: SearchByString
  // Desc: Searches the movie catalog for a specific string in the movie title or director fields. The search is case-sensitive and displays all matching entries with the movie details.
  // Precondition: m_movieCatalog must be populated.
  // Postcondition: Lists all movies where the title or director contains the given string.
  void SearchByString();
  // Name: SearchByYear
  // Desc: Allows the user to search for movies from a specific year. Prompts the user to enter a year, then lists all movies released in that year.
  // Precondition: m_movieCatalog must be populated.
  // Postcondition: Lists all movies from the specified year.
  void SearchByYear();
  // Name: SearchByProfit
  // Desc: Allows the user to search for movies that have earned a minimum specified profit. Profit is calculated as gross revenue minus the budget. The user inputs a minimum profit value, and the function displays all movies that meet or exceed this value.
  // Precondition: m_movieCatalog must be populated.
  // Postcondition: Lists all movies with a profit greater than or equal to the specified minimum profit.
  void SearchByProfit();
